...
// NEW: Statistics Routes (phải đặt trước routes với :id params)
...
// Existing route for getting trainer events - hỗ trợ query parameters (viewType, date, year, month, week, startDate, endDate)
